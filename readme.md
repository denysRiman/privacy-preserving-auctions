...
- `off-chain-common/`: Shared Rust playground/prototype for garbling, Merkle proofs, and parity vectors.
...
- `scripts/`: Local helper scripts to start Anvil and run the 3-case end-to-end protocol CLI demo.
